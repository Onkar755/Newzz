...
import com.example.newzz.databinding.FragmentTrendingBinding
...
class TrendingFragment : Fragment(), OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        binding.trendingNews = newsViewModel
        newsViewModel.getNews("news", "trending")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsViewModel.trendingNews.observe(viewLifecycleOwner, Observer { articles ->
    ...
    override fun onItemClick(article: Article) {
        ...
        if (source != null) {
            if (source.id.isNullOrEmpty()) {
                ...
                Log.e(
                    "Error",
                    "Article source ID is null or empty. Setting a default value. \n ${article.source.toString()}"
                )
            }
        }
